...
RUN curl -sL -o /tmp/node.rpm 'https://rpm.nodesource.com/pub_0.12/el/7/x86_64/nodejs-0.12.18-1nodesource.el7.centos.x86_64.rpm' \
    ...
    && yum install python27-pip openssh-clients git gcc libxml2-devel libyaml-devel libxslt-devel zlib-devel libtiff-devel libjpeg-devel zlib-devel freetype-devel lcms2-devel libwebp-devel tcl-devel libxslt python27-devel bzip2 freetype fontconfig python26 parallel python36 python36-devel python36-pip python36-setuptools python36-virtualenv -y \
    && yum clean all \
